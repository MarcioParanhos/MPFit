...
module.exports = {
  ...
  async cancelStart(dayId) {
    ...
    const db = loadFile(); const did = Number(dayId); const day = db.days.find(d => d.id === did); if (!day) return false; day.startedAt = null; day.finishedAt = null; day.durationSeconds = null; saveFile(db); return day;
  }
};
